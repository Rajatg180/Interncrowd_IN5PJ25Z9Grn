...
class _HomePageState extends State<HomePage> {
  ...
  List<Question> _questions = [
    Question(id: '1', title: "What is the time complexity of accessing an element in an array?", options: {
      'O(1)': true,
      'O(log n)': false,
      'O(n)': false,
      'O(n^2)': false
    ...
    Question(
        ...
        options: {'Queue': false, 'Stack': true, 'Heap': false, 'Tree': false}),
    ...
    Question(id: '6', title: "Which algorithm is used for finding the shortest path in a weighted graph?", options: {
      'BFS': false,
      'DFS': false,
    ...
    Question(
        id: '7',
        title: "Which data structure is used for implementing a priority queue?",
        options: {
          'Queue': false,
          'Stack': false,
          'Heap': true,
    ...
    Question(
        id: '8',
        title: "Which algorithm is used for finding the maximum flow in a flow network?",
        options: {
          'BFS': false,
          'DFS': false,
          'Dijikstra\'s algorithm': false,
          'Ford-Fulkerson algorithm': true
        }),
    ...
    Question(
        id: '10',
        title: "Which data structure is used for implementing a hash table?",
        options: {
          'Queue': false,
          'Stack': false,
          'Heap': false,
